...
export default auth((req: NextRequest & { auth: any }) => {
  ...
  const publicApiRoutes = [
    ...
    '/api/admin/fix-sequence-and-resync',    // advance sequence + resync specific deals (token-protected)
