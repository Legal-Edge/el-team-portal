...
function IconDocs() {
  return <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" /></svg>
}
function IconAdmin() {
...
const NAV_BY_ROLE: Record<TeamRole, NavItem[]> = {
  admin: [
    ...
    { label: 'Cases',     href: '/cases',              icon: <IconCases /> },
    { label: 'Finance',   href: '/finance',            icon: <IconFinance /> },
    { label: 'Settings',  href: '/settings/users',     icon: <IconSettings /> },
